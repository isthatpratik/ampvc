        ...
        <div className="mb-8 flex">
          <h2 className="text-h6 font-normal leading-tight flex gap-6">
            ...
            <div className="flex-wrap text-body-2 lg:text-h6 lg:font-medium">
              <span className=" text-white leading-tight">Ampersand</span>{" "}
              offers expert advisory services to well-funded startups, guiding
              them through critical growth stages. Leverage our expertise for
                ...
                {section.links.map((link) => (
                  ...
                  >
                    ...
                    >
                      <button
                        onClick={() =>
                          handleLinkClick(section.title, link.text)
                        }
        ...
        <div className="border-gray-800">
          ...
          <div className="flex flex-nowrap lg:flex-row flex-col items-center justify-between gap-4">
            <div className="flex font-light text-[#798682] text-caption gap-4 items-center lg:justify-normal">
              <button
                onClick={() => {
                  onStaticPageSelect?.("terms-of-use");
                  window.scrollTo({ top: 0, behavior: "smooth" });
                }}
              ...
              <button
                onClick={() => {
                  onStaticPageSelect?.("privacy-policy");
                  window.scrollTo({ top: 0, behavior: "smooth" });
                }}
                className="hover:text-white"
              >
