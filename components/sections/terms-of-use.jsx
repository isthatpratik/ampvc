    ...
    <div className="min-h-screen text-black">
      ...
      >
        ...
        <div className="mb-10 px-10 pt-6 flex flex-col space-y-8">
          <h1 className="font-semibold text-h3">Terms of Use</h1>
        ...
        <div className="space-y-5">
          ...
          <section className="relative">
            <div className="flex p-6 pr-10 items-center">
              ...
              <div className="grid ml-10">
                <h2 className="mb-2 text-h5 font-semibold">Use of Services</h2>
          ...
          <section className="relative bg-[#F7F8F8]">
            <div className="flex p-6 pr-10 items-center">
              ...
              <div className="grid ml-10">
                <h2 className="mb-2 text-h5 font-semibold">Indemnification</h2>
                <div className="space-y-4 text-body-2">
                  <p>
          ...
          <section className="relative bg-[#F7F8F8]">
            <div className="flex p-6 pr-10 items-center">
              ...
              <div className="grid ml-10">
                <h2 className="mb-2 text-h5 font-semibold">Termination</h2>
                <div className="space-y-4 text-body-2">
                  <p>
